...
export default function Header18({ scroll, isMobileMenu, handleMobileMenu }) {
    return (
        <>
                                ...
                                <div className="header-elements">
                                    ...
                                    <div className="main-menu-ex homepage5 mainmenuex1">
                                        <ul>
                                            ...
                                            <li><Link href="/#service" className="font-outfit font-18 weight-500 color-1">Our Services
                                            </Link></li>
