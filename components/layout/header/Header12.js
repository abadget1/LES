...
export default function Header12({ scroll, isMobileMenu, handleMobileMenu }) {
    return (
        <>
                                ...
                                <div className="header-elements">
                                    ...
                                    <div className="contact-3 d-lg-block d-none">
                                        <div className="all-3-btn theme-btn1 themeniceall">
                                            <Link href="/contact1" className="font-outfit font-16 lineh-16 weight-600 color-h12 theme-btn13">Start Your
                                                Journey Today</Link>
                                        </div>
                                    </div>
                                </div>
