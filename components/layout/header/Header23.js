...
export default function Header23({ scroll, isMobileMenu, handleMobileMenu }) {
    return (
        <>
                                    ...
                                    <div className="contact-3 d-lg-block d-none">
                                        <div className="all-3-btn theme-btn1 themeniceall">
                                            <div className="first-name-input header3">
                                                <select name="country" className="country-area">
                                                    <option value={1} data-display="ENG" className="font-outfit weight-600">ENG</option>
                                            ...
                                            <div className="theme-btn-3 themeall-4">
                                                ...
                                                <div className="phonr6-area1">
                                                    <p className="font-16 lineh-16 color-h11 weight-400 font-outfit margin-b8">Free Consultation</p>
