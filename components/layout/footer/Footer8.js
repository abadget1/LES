                    ...
                    <div className="row">
                        <div className="col-lg-12">
                                    ...
                                    <div className="col-lg-3 col-md-6">
                                        <div className="contact-footer contactfooter8">
                                            ...
                                            <div className="email4 margin-t">
                                                ...
                                                <Link href="/tel:123-456-7890" className="font-16 lineh-24 colorhp1 weight-500 font-ks">123-456-7890</Link>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="copyright6 text-center">
                                <p className="font-ks lineh-26 weight-500 font-16 colorhp1">© Copyright {new Date().getFullYear()} Consalt Law Consultant,
